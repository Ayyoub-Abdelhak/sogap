...
/**
 * Products table avoir RG version (retenue de garantie on HT).
 *
 * @package TextParser
 *
 ...
 */
class ProductsTableAvoirRGVersion extends Base
{
    ...
    public function process()
    {
        ...
        if (!empty($groupModels)) {
            ...
            $totalHT = $ht - $remise;
            $rgValue = intval($invoiceModel->get('retenue_garantie'));
            ...
            if ($retenueGarantie > 0) {
				...
				<tr>
					<td style="width:75%;text-align:center;border:1px solid black;">TOTAL HT APRÈS RG</td>
					<td style="width: 25%;text-align:center;border:1px solid black;">' . \CurrencyField::convertToUserFormat($totalRGHT, null, true) . '</td>
				</tr>';
            }
            if ($totalTVA > 0) {
                $html .= '
