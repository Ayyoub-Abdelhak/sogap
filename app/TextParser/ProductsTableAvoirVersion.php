...
/**
 * Products table avoir standard version (with reception definitive).
 *
 * @package TextParser
 *
 ...
 */
class ProductsTableAvoirVersion extends Base
{
    ...
    public function process()
    {
        ...
        if (!empty($groupModels)) {
            ...
            $totalTVA = ($receptionDefinitive > 0 || $remise > 0) ? $totalHT * 0.2 : $tax;
