 ...
 */
class ProductsTableFactureSOMAGECVersion extends Base
{
                    ...
                    <table style="width:100%;font-size:8px;margin-top:15px;border:1px solid black;font-weight:bold;">
                        <tr>
                            <td style="width:75%;text-align:center;border-right-style:solid;border-right-width:1px;border-bottom-style:solid;border-bottom-width:1px;">
                                Montant Total NET / USD
                            </td>
                            <td style="width: 25%;text-align:center;border-bottom-style:solid;border-bottom-width:1px;">' . \CurrencyField::convertToUserFormat($ttc, null, true) . '</td>
                        </tr>
                        <tr>
                            <td style="width:75%;text-align:center;border-right-style:solid;border-right-width:1px;border-bottom-style:solid;border-bottom-width:1px;">
                                REMISE 5%
                            </td>
                            <td style="width: 25%;text-align:center;border-bottom-style:solid;border-bottom-width:1px;">' . \CurrencyField::convertToUserFormat($ht * 0.05, null, true) . '</td>
                        </tr>
                        <tr>
                            <td style="width:75%;text-align:center;border-right-style:solid;border-right-width:1px;border-bottom-style:solid;border-bottom-width:1px;">
                                Montant Total après remise de 5% NET / USD
                            </td>
                            <td style="width: 25%;text-align:center;border-bottom-style:solid;border-bottom-width:1px;">' . \CurrencyField::convertToUserFormat(($ht * 0.95) * 1.2, null, true) . '</td>
                        </tr>
                        <tr>
                            <td style="width:75%;text-align:center;border-right-style:solid;border-right-width:1px;border-bottom-style:solid;border-bottom-width:1px;">
                                REMISE 3%
                            </td>
                            <td style="width: 25%;text-align:center;border-bottom-style:solid;border-bottom-width:1px;">' . \CurrencyField::convertToUserFormat($ht * 0.03, null, true) . '</td>
                        </tr>
                        <tr>
                            <td style="width:75%;text-align:center;border-right-style:solid;border-right-width:1px;border-bottom-style:solid;border-bottom-width:1px;">
                                Montant Total  / USD
                        ...
                        <tr>
                            ...
                            <td style="width: 25%;text-align:center;border-bottom-style:solid;border-bottom-width:1px;"> </td>
                        </tr>
                        <tr>
