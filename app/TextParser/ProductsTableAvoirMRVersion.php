...
/**
 * Products table avoir MR version (HT only, no TVA).
 *
 * @package TextParser
 *
 ...
 */
class ProductsTableAvoirMRVersion extends Base
{
    ...
    public function process()
    {
        ...
        if (!empty($groupModels)) {
            ...
            $html .= '<div style="font-size:9px;margin-top:20px;"><b>ARRÊTÉ LE PRÉSENT AVOIR À LA SOMME DE :</b><br /><b>' . \Vtiger_Util_Helper::int2str($totalHT) . $currency . ' HT</b></div>';
        }
        return $html;
    }
}
