<?php
/* Smarty version 4.2.0, created on 2024-05-10 18:03:34
  from 'C:\xampp\htdocs\yetiforce\layouts\basic\modules\Settings\MappedFields\Step2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_663e5366cfdb81_97059944',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'af0e176bf5bc2d380dc8b781575f8dcfe3d47e5e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\yetiforce\\layouts\\basic\\modules\\Settings\\MappedFields\\Step2.tpl',
      1 => 1702905763,
      2 => 'file',
    ),
  ),
...
function content_663e5366cfdb81_97059944 (Smarty_Internal_Template $_smarty_tpl) {
...
" /><?php $_smarty_tpl->_assignInScope('PARAMS', $_smarty_tpl->tpl_vars['MAPPEDFIELDS_MODULE_MODEL']->value->get('params'));?><div class="col-md-12 px-0"><div class="card"><div class="card-header"><label><strong><?php echo \App\Language::translateArgs('LBL_STEP_N',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value,2);?>
...
</strong></button><div class="checkbox col-md-8 align-self-center"><label class="mr-1"><input class="mr-1" type="checkbox" name="autofill" <?php if (!empty($_smarty_tpl->tpl_vars['PARAMS']->value['autofill'])) {?> checked <?php }?>><?php echo \App\Language::translate('LBL_AUTOFILL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
$_smarty_tpl->_assignInScope('SEQ', (isset($_smarty_tpl->tpl_vars['__smarty_foreach_mappingLoop']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_mappingLoop']->value['iteration'] : null));?><tr class="listViewEntries" sequence-number="<?php echo $_smarty_tpl->tpl_vars['SEQ']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select><input type="hidden" class="mappingType" name="mapping[<?php echo $_smarty_tpl->tpl_vars['SEQ']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></td><td class=""><?php if ($_smarty_tpl->tpl_vars['MAPPING_ARRAY']->value['default']) {?><input type="hidden" class="form-control default" value="<?php echo $_smarty_tpl->tpl_vars['MAPPING_ARRAY']->value['default'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?><tr class="d-none newMapping listViewEntries"><td><select class="sourceFields newSelect"><option data-type="<?php echo \App\Language::translate('LBL_NONE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select><input type="hidden" class="mappingType" value="" /></td><td class="selectedFieldDataType text-center alignMiddle"></td><td><select class="targetFields newSelect"><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['REL_MODULE_MODEL']->value->getFields(), 'FIELDS', false, 'BLOCK_NAME');
$_smarty_tpl->tpl_vars['FIELDS']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['BLOCK_NAME']->value => $_smarty_tpl->tpl_vars['FIELDS']->value) {
$_smarty_tpl->tpl_vars['FIELDS']->do_else = false;
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></td><td class=""></td><td class="textAlignCenter"><button title="<?php echo \App\Language::translate('LBL_DELETE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</button></div></div></div></div></form></div><div class="d-none" id="defaultValuesElementsContainer"><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['REL_MODULE_MODEL']->value->getFields(), 'FIELDS', false, 'BLOCK_NAME');
$_smarty_tpl->tpl_vars['FIELDS']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['BLOCK_NAME']->value => $_smarty_tpl->tpl_vars['FIELDS']->value) {
$_smarty_tpl->tpl_vars['FIELDS']->do_else = false;
...
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['_FIELD_ID']->value => $_smarty_tpl->tpl_vars['_FIELD_INFO']->value) {
...
_defaultvalue" <?php if ($_smarty_tpl->tpl_vars['_FIELD_TYPE']->value == 'multipicklist') {?> multiple <?php }?>class="form-control" disabled><?php if ($_smarty_tpl->tpl_vars['_FIELD_TYPE']->value != 'multipicklist') {?><option value=" "><?php echo \App\Language::translate('LBL_SELECT_OPTION','Vtiger');?>
</option><?php }
...
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['KEY']->value => $_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value) {
$_smarty_tpl->tpl_vars['PICKLIST_VALUE']->do_else = false;
?><option value="<?php echo \App\Purifier::encodeHtml($_smarty_tpl->tpl_vars['KEY']->value);?>
"><?php echo \App\Purifier::encodeHtml($_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value);?>
</option><?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select><?php } elseif (in_array($_smarty_tpl->tpl_vars['_FIELD_TYPE']->value,array('owner','sharedOwner')) || $_smarty_tpl->tpl_vars['_FIELD_UITYPE']->value == '52') {?><select id="<?php echo $_smarty_tpl->tpl_vars['_FIELD_ID']->value;?>
...
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['BLOCK_NAME']->value => $_smarty_tpl->tpl_vars['ITEM']->value) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select><?php } elseif ($_smarty_tpl->tpl_vars['_FIELD_TYPE']->value == 'date') {?><input type="text" id="<?php echo $_smarty_tpl->tpl_vars['_FIELD_ID']->value;?>
_defaultvalue"data-date-format="<?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->get('date_format');?>
...
_defaultvalue"class="defaultInputTextContainer form-control col-md-2" value=""data-date-format="<?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->get('date_format');?>
