...
/* Smarty version 4.2.0, created on 2023-12-29 11:57:16
  from 'C:\xampp\htdocs\yetiforce\layouts\basic\modules\Settings\PDF\ListViewContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_658ea60c8daff5_44330462',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'eec78dfd4f919a8ff7ca42ed4ee2dbf862147d9c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\yetiforce\\layouts\\basic\\modules\\Settings\\PDF\\ListViewContents.tpl',
      1 => 1702905764,
      2 => 'file',
    ),
  ),
...
function content_658ea60c8daff5_44330462 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- tpl-Settings-PDF-ListViewContents --><input type="hidden" id="pageStartRange" value="<?php echo $_smarty_tpl->tpl_vars['PAGING_MODEL']->value->getRecordStartRange();?>
...
" id="noOfEntries"><div class="listViewEntriesDiv u-overflow-scroll-non-desktop overflowXAuto mt-2"><?php ob_start();
echo 99/(count($_smarty_tpl->tpl_vars['LISTVIEW_HEADERS']->value));
$_prefixVariable1 = ob_get_clean();
$_smarty_tpl->_assignInScope('WIDTH', $_prefixVariable1);?><div class="table-responsive"><table class="table table-bordered table-sm listViewEntriesTable"><?php $_smarty_tpl->_subTemplateRender(\App\Layout::getTemplatePath('ListView/TableHeader.tpl',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?><tbody><?php
...
"></span></a><?php } else { ?><a <?php if (stripos($_smarty_tpl->tpl_vars['RECORD_LINK_URL']->value,'javascript:') === 0) {?> onclick="<?php echo substr($_smarty_tpl->tpl_vars['RECORD_LINK_URL']->value,strlen("javascript:"));?>
...
</td></tr></tbody></table><?php }?></div><!-- /tpl-Settings-PDF-ListViewContents -->
<?php }
}
